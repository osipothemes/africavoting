                    ...
                    <tbody>
                        ...
                        <?php foreach ($organizers as $organizer) : ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" data-toggle="modal" data-target="#a22ctivateModal<?= $organizer->or_id ?>" class="btn btn-warning btn-sm" title="Activate"><i class="zmdi zmdi-settings"></i></a>
                                </td>
                            </tr>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body"> 
                                            ...
                                            <p>Your about to change the account status for <b><?= $organizer->or_company_name ?></b></p>
