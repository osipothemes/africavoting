                    ...
                    <tbody>
                        ...
                        <?php foreach ($editions as $edition) : ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="single-user-name" href="javascript:void(0);"><?= substr($edition->edname,0,20)."..."; ?></a><br>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="<?= site_url('admin/projects/edit-edition/' . $edition->edid) ?>" class="btn btn-warning btn-sm" title="Edit"><i class="zmdi zmdi-edit"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
